    ...
    <div id="joblistdiv" style={jobliststyle} key={index}>
      <div id="cardheader" style={{ width: "100%", color: "green" }}>
        <h2 style={{ textAlign: "left" }}>
          Applied Jobs( {buttondata.proposalDate}){" "}
        </h2>
        <button
          onClick={() => {
            console.log(buttondata);
...
const Guarantors = ({ index, buttondata }) => {
  ...
  return (
    <div id="joblistdiv" style={jobliststyle} key={index}>
      <div id="cardheader" style={{ width: "100%", color: "green" }}>
        <h2 style={{ textAlign: "left" }}>
          Guarantor State:{buttondata.gstate}
        </h2>
        <button
          onClick={() => {
            console.log(buttondata);
      ...
      <div id="card-details">
        <table>
          ...
          <tr>
            ...
            <td>
              {buttondata.gfirstname +
                "  " +
                " " +
                buttondata.glastname +
                " " +
                " "}
            </td>
          </tr>
      ...
      <div id="card-details">
        <table>
          ...
          <tr>
            ...
            <td>{buttondata.apartmentType}</td>
          </tr>
          <tr>
            <td>Selected Chorse</td>
            <td>{buttondata.selectedChores}</td>
          </tr>
          <tr>
            <td>Time Stamp</td>
