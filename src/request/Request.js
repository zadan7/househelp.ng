...
import { renderSignuppay } from "../home/Signup";
  ...
  useEffect(() => {
    ...
    function getgformdata() {
      ...
      if (
        ...
        document.querySelector("#gn2").innerHTML =
          "failed to send one or more fields are left Blank or email is incorrect";
      }
    }

    document
      .querySelector("#gsignup_submit_button")
    ...
    <div className="div" style={signcss}>
      <form style={{}}>
        <div id="gsignupform">
          ...
          <p>Guarantor Firstname</p>
          <input type="text" id="gfirstname" required></input>
          <p>Guarantor Lastname </p>{" "}
          <input type="text" id="glastname" required></input>
          ...
          <p>
            ...
            <span style={{ color: "red" }}>
              {" "}
              <br></br>(Work address, name of company or name of Job )
            </span>
          </p>
          <input type="text" id="gjob_type" required></input>
          ...
          <input type="number" id="gpnumber" required></input>
          <p>Guarantor Email </p>
          <input type="email" id="gemail" required></input>
          <br></br>
          <button type="submit" value="Submit" id="gsignup_submit_button">
            Submit
          </button>
        </div>
        <div id="gdatadiv">
          <img
            ...
            src={verified}
            alt="verified"
            style={{ textAlign: "center", marginBottom: "15px" }}></img>
          <br></br>
      ...
      <div>
        <div className="container" id="fulltime-container">
          <div
            ...
            <img
              src={leftarrow}
              style={{ width: "100%", color: "green" }}></img>
          </div>

          <form
            style={{ display: "block" }}
            name="Application Requests for Fulltime Househelps"
            netlify>
            ...
            <input type="text" id="middlename" required></input>
            <label>Phone Number</label>
            <input type="text" id="phonenumber" required></input>
            <label htmlFor="product-picture">face image</label>
            <br></br>
            <input type="file" id="file" required></input>
            <label>Email</label>
            <input type="Email" id="email2" required></input>
            ...
            <div style={{ textAlign: "center" }}>
              <label>
                Yes<input type="radio" name="Kids" value="Yes"></input>
              </label>
              <label>
                No <input type="radio" name="Kids" value="No"></input>
              </label>
            </div>
            ...
            <label>
              ...
              <span style={{ color: "red" }}>
                {" "}
                describe exactly why and what you need the Househelp for, also
                add resuption time and closing time.
              </span>
              )
            </label>
            <textarea
            ...
            <label>
              i have Agreed to all &copy Househelp Terms & Conditions{" "}
...
class Partime extends React.Component {
  ...
  componentDidMount() {
    function validateAmount() {
      ...
      if (Amount < 3000) {
        document.querySelector("#H3id").innerHTML =
          "Sorry Your Request is Below The Minimum amount(N3,500), you need to Add More House Chorse";
      } else {
    ...
    function setprice(array) {
      ...
      var totals = pricearray.reduce(function (acc, val) {
        return acc + val;
      }, 0);
  ...
  render() {
    return (
      <div>
        ...
        <h1 style={{ textAlign: "center" }} id="H1id">
          N{}
        </h1>
        <h3
        ...
        <div id="container">
          <p style={{ color: "green" }}>
            Please Select House chores to be completed by the Househelp
          </p>
          <button className="fresh">Clean Living Room</button>
          <button className="fresh">Wash Bathroom</button>

          <button className="fresh">Clean Personal Room</button>
          <button className="fresh">Wash Dishes</button>
          <button className="fresh">Wash Car</button>
  ...
  return (
    <div>
      <div id="container">
        ...
        <br></br>
        <p>
          Your Payment Was Successfull And @Househelp.ng will Start Processing
          Your Request Immediately, <br></br>
          we will also Reach out to you within a week through your Email, and
          also Follow Up with Calls, Thank You For Always Choosing @househelp.ng
          God Bless You. if your request is not completed within 2 weeks your
      ...
      <div style={{ textAlign: "center" }}>
        ...
        <div
          ...
          <span style={{ width: "200px" }}>
            kindly note that Under no circumstances Should payment be made
            directly to any Of Our Househelps All Payments should be made
            Directly to @househelp.ng Account 0230388040 wema Bank(sadam umaru
            Mohammed) .<br></br>
            Secondly @Househelp.ng Charges A onetime Service Charge fee of
            N10,000 <br></br>
            this fee is to be payed before the Agreed Househelp resumes his/her
            official Duty & our client(customer) has carried Out A Successfull
            Interview with the Househelp.
            <br></br>
            <br></br>
            the Monthly fee Of N30,000<br></br>
            should be payed directly to the company account which is stated
            below.<br></br>
    ...
    <div>
      <div
        ...
        <p style={{ borderBottom: "2px solid black" }}>
          {" "}
          Consultation Fee <span> (non-refundable) </span> =N2000
        </p>
        <p style={{ borderBottom: "2px solid black" }}> Request Fee =N1500</p>
        <p style={{ borderBottom: "2px solid black" }}>
          {" "}
          Total Amount Due =N 3,500
        </p>
